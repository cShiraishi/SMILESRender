...
1. **Local Computations:** Utilizing the open-source `RDKit` cheminformatics toolkit for 2D molecular drawing, smart canonicalization, and computation of constitutional, topological, and Lipinski-based violation descriptors.
